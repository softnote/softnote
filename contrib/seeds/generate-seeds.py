...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef SOFTNOTE_CHAINPARAMSSEEDS_H\n')
    g.write('#define SOFTNOTE_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the softnote network\n')
    ...
    g.write('#endif // SOFTNOTE_CHAINPARAMSSEEDS_H\n')
