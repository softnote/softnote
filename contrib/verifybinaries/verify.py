...
softnotecore.org and softnote.org and compares them.
...
WORKINGDIR = "/tmp/softnote_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://softnotecore.org"
HOST2 = "https://softnote.org"
VERSIONPREFIX = "softnote-core-"
...
def main(args):
    ...
    if not success:
        print("softnote.org failed to provide signature file, "
              "but softnotecore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("softnote.org and softnotecore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Softnote Core binary release "
