...
(define* (make-softnote-cross-toolchain target
                                       #:key
...
desirable for building Softnote Core release binaries."
...
(define glibc-2.27/softnote-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-softnote-cross-toolchain target
                                                      #:base-libc glibc-2.27/softnote-patched
