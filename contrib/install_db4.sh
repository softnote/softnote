...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the softnote repository."
  exit 1
fi
...
# See https://github.com/softnote/softnote/issues/16064
...
echo 'When compiling softnoted, run `./configure` in the following way:'
echo
