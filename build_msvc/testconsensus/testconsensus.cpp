...
// softnote includes.
#include <..\src\script\softnoteconsensus.h>
...
int main()
{
    std::cout << "softnoteconsensus version: " << softnoteconsensus_version() << std::endl;
    ...
    auto op0Result = softnoteconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, softnoteconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
