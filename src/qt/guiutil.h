...
#ifndef SOFTNOTE_QT_GUIUTIL_H
#define SOFTNOTE_QT_GUIUTIL_H
...
/** Utility functions used by the Softnote Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "softnote:" URI into recipient object, return true on successful parsing
