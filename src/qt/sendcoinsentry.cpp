    ...
    platformStyle(_platformStyle)
{
    ...
    // normal softnote address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying softnote address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &SoftnoteAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
