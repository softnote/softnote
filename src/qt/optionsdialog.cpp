    ...
    mapper(nullptr)
{
    ...
    ui->softnoteAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->softnoteAtStartup);
    ...
    ui->softnoteAtStartup->setToolTip(ui->softnoteAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->softnoteAtStartup->setText(ui->softnoteAtStartup->text().arg(PACKAGE_NAME));

    ui->openSoftnoteConfButton->setToolTip(ui->openSoftnoteConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new SoftnoteUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->softnoteAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openSoftnoteConfButton_clicked()
{
