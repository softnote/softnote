 ...
 */
#ifndef SOFTNOTE_UTIL_SYSTEM_H
#define SOFTNOTE_UTIL_SYSTEM_H
...
extern const char * const SOFTNOTE_CONF_FILENAME;
extern const char * const SOFTNOTE_SETTINGS_FILENAME;
