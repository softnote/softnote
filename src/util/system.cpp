...
// For details see https://github.com/softnote/softnote/pull/22348.
...
const char * const SOFTNOTE_CONF_FILENAME = "softnote.conf";
const char * const SOFTNOTE_SETTINGS_FILENAME = "settings.json";
 ...
 * https://github.com/softnote/softnote/pull/16097#issuecomment-514627823
 */
...
bool ArgsManager::ParseParameters(int argc, const char* const argv[], std::string& error)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (key == "-") break; //softnote-tx using stdin
        std::string val;
...
bool ArgsManager::GetSettingsPath(fs::path* filepath, bool temp) const
{
    ...
    if (filepath) {
        std::string settings = GetArg("-settings", SOFTNOTE_SETTINGS_FILENAME);
...
{
    // Windows: C:\Users\Username\AppData\Roaming\Softnote
    // macOS: ~/Library/Application Support/Softnote
    // Unix-like: ~/.softnote
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Softnote";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Softnote";
#else
    // Unix-like
    return pathRet / ".softnote";
#endif
#endif
}
...
bool ArgsManager::ReadConfigFiles(std::string& error, bool ignore_invalid_keys)
{
    ...
    const std::string confPath = GetArg("-conf", SOFTNOTE_CONF_FILENAME);
