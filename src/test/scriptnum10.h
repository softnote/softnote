...
#ifndef SOFTNOTE_TEST_SCRIPTNUM10_H
#define SOFTNOTE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Softnote Core 0.10.0, for cross-comparison.
 */
public:
