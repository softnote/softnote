...
#ifndef SOFTNOTE_NET_H
#define SOFTNOTE_NET_H
 ...
 * src/qt/guiutil.cpp and src/softnote-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Softnote’s Peer-to-Peer Network")
