...
#ifndef SOFTNOTE_SCRIPT_STANDARD_H
#define SOFTNOTE_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a softnote address
 */
...
/**
 * Generate a Softnote scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // SOFTNOTE_SCRIPT_STANDARD_H
