...
#ifndef SOFTNOTE_INTERFACES_INIT_H
#define SOFTNOTE_INTERFACES_INIT_H
...
//! (softnote-gui, softnote-node, softnote-wallet, softnoted, softnote-qt) and each
...
#endif // SOFTNOTE_INTERFACES_INIT_H
