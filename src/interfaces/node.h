...
#ifndef SOFTNOTE_INTERFACES_NODE_H
#define SOFTNOTE_INTERFACES_NODE_H
...
//! Top-level interface for a softnote node (softnoted process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // SOFTNOTE_INTERFACES_NODE_H
