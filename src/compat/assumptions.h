...
#ifndef SOFTNOTE_COMPAT_ASSUMPTIONS_H
#define SOFTNOTE_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Softnote cannot be compiled without assertions."
#endif
...
#endif // SOFTNOTE_COMPAT_ASSUMPTIONS_H
