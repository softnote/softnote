...
#ifndef SOFTNOTE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define SOFTNOTE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // SOFTNOTE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
