...
#ifndef SOFTNOTE_WALLET_WALLETUTIL_H
#define SOFTNOTE_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! softnote from opening the wallet, thinking it was newly created, and
...
#endif // SOFTNOTE_WALLET_WALLETUTIL_H
