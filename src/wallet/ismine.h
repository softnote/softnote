...
#ifndef SOFTNOTE_WALLET_ISMINE_H
#define SOFTNOTE_WALLET_ISMINE_H
 ...
 * https://github.com/softnote/softnote/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // SOFTNOTE_WALLET_ISMINE_H
