...
#ifndef SOFTNOTE_WALLET_SCRIPTPUBKEYMAN_H
#define SOFTNOTE_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Softnote Core wallet was originally a collection of unrelated private
...
#endif // SOFTNOTE_WALLET_SCRIPTPUBKEYMAN_H
