...
#ifndef SOFTNOTE_POLICY_POLICY_H
#define SOFTNOTE_POLICY_POLICY_H
...
static const unsigned int MAX_STANDARD_TX_SIGOPS_COST = MAX_BLOCK_SIGOPS_COST/15;
...
#endif // SOFTNOTE_POLICY_POLICY_H
