 ...
 * for both softnoted and softnote-qt, to make it harder for attackers to
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/softnote/bips/blob/master/bip-0014.mediawiki)
 */
