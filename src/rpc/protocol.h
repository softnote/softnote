...
#ifndef SOFTNOTE_RPC_PROTOCOL_H
#define SOFTNOTE_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in softnoted
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Softnote is not connected
