...
bool MemPoolAccept::PreChecks(ATMPArgs& args, Workspace& ws)
{
    ...
    if (!m_pool.CalculateMemPoolAncestors(*entry, setAncestors, m_limit_ancestors, m_limit_ancestor_size, m_limit_descendants, m_limit_descendant_size, errString)) {
        ...
        // this, see https://lists.linuxfoundation.org/pipermail/softnote-dev/2018-November/016518.html
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    CAmount nSubsidy = (nHeight == 1 ? 45035000 : 50) * COIN;
...
// Do Not Allow Forks Prior to Checkpoint

if (pindex->nHeight == 3779 && !((pindex->GetBlockHash() == uint256S("0x00000000f6626891f067e93529c0adfe07460d1754af14dcd8136c2aeb00a0ec")))) { 
LogPrintf("ERROR: ConnectBlock(): Blockchain must not fork below checkpoint height\n");
...
bool ChainstateManager::ProcessNewBlock(const CChainParams& chainparams, const std::shared_ptr<const CBlock>& block, bool force_processing, bool* new_block)
{
...

    {
        ...
        // https://lists.linuxfoundation.org/pipermail/softnote-dev/2019-February/016697.html.  Because CheckBlock() is
