...
#ifndef SOFTNOTE_CRYPTO_CHACHA_POLY_AEAD_H
#define SOFTNOTE_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@softnote.
 *
 ...
 *
 * The chacha20-poly1305@softnote combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@softnote cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@softnote are relatively fast in
...
#endif // SOFTNOTE_CRYPTO_CHACHA_POLY_AEAD_H
