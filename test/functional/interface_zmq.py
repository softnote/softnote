...
class ZMQTest (SoftnoteTestFramework):
    ...
    def test_sequence(self):
        ...
        [seq] = self.setup_zmq_test([("sequence", "tcp://127.0.0.1:217605")])
        self.disconnect_nodes(0, 1)
    ...
    def test_multiple_interfaces(self):
        ...
        subscribers = self.setup_zmq_test([
            ("hashblock", "tcp://127.0.0.1:217630"),
