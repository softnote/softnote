...
By default, softnoted will dump mempool on shutdown and
...
class MempoolPersistTest(SoftnoteTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent softnoted from writing mempool.dat to disk. Verify that `savemempool` fails")
