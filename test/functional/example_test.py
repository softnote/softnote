...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SoftnoteTestFramework
    pass


class ExampleTest(SoftnoteTestFramework):
    # Each functional test is a subclass of the SoftnoteTestFramework class.
    ...
    def custom_method(self):
        ...
        SoftnoteTestFramework class so other tests can use it."""
