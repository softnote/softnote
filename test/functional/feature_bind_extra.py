...
"""
Test starting softnoted with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(SoftnoteTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that softnoted has bound on "::1" (for RPC) and "::" (for P2P).
