...
"""Verify that starting softnote with -h works as expected."""

from test_framework.test_framework import SoftnoteTestFramework
from test_framework.util import assert_equal

class HelpTest(SoftnoteTestFramework):
    ...
    def run_test(self):
        self.log.info("Start softnote with -h for help text")
        ...
        self.log.info("Start softnote with -version for version information")
        ...
        self.log.info("Start softnoted with -fakearg to make sure it does not start")
