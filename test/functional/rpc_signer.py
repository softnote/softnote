...
Verify that a softnoted node can use an external signer command.
...
class RPCSignerTest(SoftnoteTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart softnoted with -signer=<cmd>',
