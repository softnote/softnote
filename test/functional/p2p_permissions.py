...
class P2PPermissionsTests(SoftnoteTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].softnoteconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].softnoteconf, 'w', encoding="utf8") as f:
            f.write(newText)
