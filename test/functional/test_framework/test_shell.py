...
class TestShell:
    """Wrapper Class for SoftnoteTestFramework.

    The TestShell class extends the SoftnoteTestFramework
    ...
    class __TestShell(SoftnoteTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by SoftnoteTestFramework child class.
            self.num_nodes = 1
