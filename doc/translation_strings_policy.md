...
This document provides guidelines for internationalization of the Softnote Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `softnote_en.ts` remains unchanged.
