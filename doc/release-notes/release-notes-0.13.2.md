Softnote Core version 0.13.2 is now available from:

  <https://softnote.org/bin/softnote-core-0.13.2/>
...
- #8908 `4a974b2` Update softnote-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow softnote-tx to create v2 transactions (sfndrak)
