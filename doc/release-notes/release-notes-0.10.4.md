Softnote Core version 0.10.4 is now available from:

  <https://softnote.org/bin/softnote-core-0.10.4/>
...
- #6953 `43c2789` Split softnote-tx into its own package
- #6953 `dfe0d4d` Include softnote-tx binary on Debian/Ubuntu
