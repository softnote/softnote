Softnote-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/softnote/files/Softnote/softnote-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Softnote
...
New/changed settings (command-line or softnote.conf file)
--------------------------------------------------------
