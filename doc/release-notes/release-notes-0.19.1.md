...
Softnote Core version 0.19.1 is now available from:

  <https://softnotecore.org/bin/softnote-core-0.19.1/>
...
From Softnote Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Softnote Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Softnote Core does not yet change appearance when
...
- #17488 fix "softnoted already running" warnings on macOS (fanquake)
