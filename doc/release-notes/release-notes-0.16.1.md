Softnote Core version 0.16.1 is now available from:

  <https://softnotecore.org/bin/softnote-core-0.16.1/>
...
- #12843 `df38b13` Test starting softnoted with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure softnoted processes are cleaned up when tests end (sdaftuar)
