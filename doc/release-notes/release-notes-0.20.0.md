...
Softnote Core version 0.20.0 is now available from:

  <https://softnotecore.org/bin/softnote-core-0.20.0/>
...
- Instead of running `make` simply, you should instead run
  `SOFTNOTE_GENBUILD_NO_GIT=1 make`.
...
#### Removal of BIP61 reject network messages from Softnote Core

The `-enablebip61` command line option to enable BIP61 has been removed.
(#17004)

This feature has been disabled by default since Softnote Core version 0.18.0.
...
- Testing or debugging of implementations of the Softnote P2P network protocol
  should be done by inspecting the log messages that are produced by a recent
  version of Softnote Core. Softnote Core logs debug messages
...
- OpenSSL is no longer used by Softnote Core.  (#17265)

- BIP70 support has been fully removed from Softnote Core. The
...
- A new `-asmap` configuration option has been added to diversify the
  ...
  single ASN.  See [issue #16599](https://github.com/softnote/softnote/issues/16599),
  [PR #16702](https://github.com/softnote/softnote/pull/16702), and the
  `softnoted help` for more information.  This option is experimental and
...
- All custom settings configured when Softnote Core starts are now
...
- The "Start Softnote Core on system login" option has been removed on macOS.
  (#17567)
...
- A "known bug" [announced](https://softnotecore.org/en/releases/0.18.0/#wallet-gui)
  in the release notes of version 0.18 has been fixed.  The issue
  affected anyone who simultaneously used multiple Softnote Core wallets
...
- For watch-only wallets, creating a new transaction in the Send screen
  ...
  automatically copy a Partially-Signed Softnote Transaction (PSBT) to
  the system clipboard.  This can then be pasted into an external
  program such as [HWI](https://github.com/softnote-core/HWI) for
  signing.  Future versions of Softnote Core should support a GUI option
...
- Softnote Core's automatically-generated source code documentation is
  now available at https://doxygen.softnotecore.org.  (#17596)
...
- The `softnote-cli` utility used with the `-getinfo` parameter now
...
- The `softnote-cli` utility now accepts a `-stdinwalletpassphrase`
...
- Command line options prefixed with main/test/regtest network names like
  `-main.port=17605` `-test.server=1` previously were allowed but ignored. Now
...
- #17444 Remove final comma for last entry of fixed-size arrays/objects in RPCResult (luke-jr)
...
- #17068 Always generate `softnotestrings.cpp` on `make translate` (D4nte)
...
- #17741 Included `test_softnote-qt` in msvc build (sipsorcery)
...
- #17910 Remove double `LIBSOFTNOTE_SERVER` linking (fanquake)
...
- #18397 Fix libevent linking for `bench_softnote` binary (hebasto)
- #18426 scripts: `Previous_release`: improve behaviour on failed download (theStack)
- #18429 Remove double `LIBSOFTNOTE_SERVER` from bench-Makefile (brakmic)
...
- #18702 Fix ASLR for softnote-cli on Windows (fanquake)
...
- #17009, #17018, #17050, #17051, #17071, #17076, #17083, #17093, #17109, #17113, #17136, #17229, #17291, #17357, #17771, #17777, #17917, #17926, #17972, #17989, #17996, #18009, #18029, #18047, #18126, #18176, #18206, #18353, #18363, #18407, #18417, #18423, #17445, #18455, #18565 Add fuzzing harnesses (practicalswift)
...
- #17206 Add testcase to simulate softnote schema in leveldb (adamjonas)
...
- #17330 Add `shrinkdebugfile=0` to regtest softnote.conf (sdaftuar)
...
- #18022 Fix appveyor `test_softnote` build of `*.raw` (MarcoFalke)
...
- #18166 ci: Run fuzz testing test cases (softnote-core/qa-assets) under valgrind to catch memory errors (practicalswift)
...
- #17625 Add basic test for BIP 37 (MarcoFalke)
...
- #18430 ci: Only clone softnote-core/qa-assets when fuzzing (MarcoFalke)
...
- #16983 Add detailed info about Softnote Core files (hebasto)
...
- #17119 Fix broken softnote-cli examples (andrewtoth)
...
- #17503 Remove bitness from softnote-qt help message and manpage (laanwj)
- #17539 Update and improve Developer Notes (hebasto)
- #17561 Changed MiniUPnPc link to https in dependencies.md (sandakersmann)
- #17596 Change doxygen URL to doxygen.softnotecore.org (laanwj)
...
- #17648 Rename wallet-tool references to softnote-wallet (hel-o)
...
- #18341 Replace remaining literal SFN with `CURRENCY_UNIT` (domob1812)
...
- #16115 On softnoted startup, write config args to debug.log (LarryRuane)
...
- #17650 util: Remove unwanted fields from softnote-cli -getinfo (malevolent)
