Softnote Core version 0.9.2.1 is now available from:

  https://softnote.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 SFN to 0.01 SFN
...
- Fix "Start softnote on system login"
