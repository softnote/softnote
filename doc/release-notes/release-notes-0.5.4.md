Softnote version 0.5.4 is now available for download at:
http://sourceforge.net/projects/softnote/files/Softnote/softnote-0.5.4/
...
http://gitorious.org/softnote/softnoted-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Softnote-Qt notifications under Growl 1.3.
Increase required age of Softnote-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSoftnote properly when installing Softnote-Qt over it. (Windows)
