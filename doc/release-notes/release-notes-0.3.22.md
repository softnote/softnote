Download URL: https://sourceforge.net/projects/softnote/files/Softnote/softnote-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 SFN fee schedule (users still pay 0.01 SFN per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #softnote00 - #softnote99
