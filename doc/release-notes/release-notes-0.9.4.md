Softnote Core version 0.9.4 is now available from:

  https://softnote.org/bin/0.9.4/
...
this update is incompatible with the Softnote system and could lead to consensus
forks.

Softnote Core released binaries from https://softnote.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~softnote/+archive/ubuntu/softnote
- A third-party or self-compiled Softnote Core

upgrade to Softnote Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
