...
Softnote Core version 0.21.1 is now available from:

  <https://softnotecore.org/bin/softnote-core-0.21.1/>
...
fungibility of all softnotes. Spenders will enjoy lower fees and the
...
The addition of taproot-related features to Softnote Core's wallet is
...
FAQ](https://softnotecore.org/en/2016/06/08/version-bits-miners-faq/) for
details.
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/softnote/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/softnote/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/softnote/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit Softnote](https://softnotemagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-softnote)
  - [What do Schnorr Signatures Mean for Softnote?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-softnote)
...
- Development history overview
  - [Taproot](https://softnoteops.org/en/topics/taproot/)
  - [Schnorr signatures](https://softnoteops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://softnoteops.org/en/topics/tapscript/)
  - [Soft fork activation](https://softnoteops.org/en/topics/soft-fork-activation/)

- Other
  - [Questions and answers related to taproot](https://softnote.stackexchange.com/questions/tagged/taproot)
...
- Due to [BIP 350](https://github.com/softnote/bips/blob/master/bip-0350.mediawiki)
  ...
  (e.g. through [BIP 341](https://github.com/softnote/bips/blob/master/bip-0341.mediawiki)).
...
### Documentation
- #21384 add signet to softnote.conf documentation (jonatack)
