Softnote Core version *0.15.2* is now available from:

  <https://softnotecore.org/bin/softnote-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in softnote-tx (TheBlueMatt)
