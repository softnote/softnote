...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Softnote
else
  DOCKER_EXEC echo \> \$HOME/.softnote
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/softnote/softnote/pull/18288#discussion_r433189350 for
  # details.
