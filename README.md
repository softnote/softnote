...
For an immediately usable, binary version of the Softnote Core software, see
https://softnote.org/en/download/.
...
out collectively by the network. Softnote Core is the name of open source
software which enables the use of this currency.

For more information read the original Softnote whitepaper.
...
The https://github.com/softnote-core/gui repository is used exclusively for the
...
[Softnote Core's Transifex page](https://www.transifex.com/softnote/softnote/).
